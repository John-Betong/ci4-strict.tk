...
.lh2 {line-height: 2.42;}
.mga {margin:0 auto;}
.p42 {padding: 0.42em 2em 0.42em ;}
...
function menu($option=[0,1,2]) : string 
{
  $result = "
  <div class='XXXmga tac'>
    <form action='?' method='post'>

      <fieldset class='dib bgs tal p42 lh2'>
        <legend> Selections: </legend>

        <input type='radio' name='$option[0]' value='qqq' >     
        <label> Insert strict declaration strict=1 </label>  
        <br>

        <input type='radio' name='option1' value='yyy' >       
        <label> set strict=1  </label>
        <br>

        <input type='radio' name='option2' value='xxx' >       
        <label> set strict=0  </label>
        <br>
