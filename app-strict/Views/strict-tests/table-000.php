...
$tbl = <<< ____EOT
  ...
  <tr>
    <td> <a href="{$strictPath}strict-0?mode=1">$pStr</a> </td>
    <td class="fgr fss"> not declared </td>
    <td class="fgr fss"> not declared </td>
    <td> {$result[1]}   </td>
    <td> {$retype[1]}   </td>
  ...
  <tr><!-- 3,4 -->
    <td> <a href="{$strictPath}strict-1?mode=3"> $pInt </a> </td>
    <td class="fgg"> Strict=1 </td>
    <td class="fgr fss"> not declared </td>
    <td> {$result[3]} </td>
    <td> {$retype[3]} </td>
  ...
  <tr><!-- 6,7 -->
    <td> <a href="{$strictPath}strict-0?mode=6"> $pStr </a> </td>
    <td class="fgr fss"> not declared </td>
    <td class="fgg"> Strict=1 </td>
    <td> {$result[6]} </td>
    <td> {$retype[6]} </td>
