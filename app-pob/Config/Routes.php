...
# $routes->get('/',             'Home::index');
  ...
  $routes->add('playground/(:any)', 'Playground::index');
  
# $routes->add('bwci4',         'C_bwci4::index');
# $routes->add('bwci4/(:any)',  'C_bwci4::index/$1');
# $routes->add('builtwithci4',  'C_bwci4::index');
# $routes->add('bwci4add',      'C_bwci4::addproject');
  
  $routes->add('bwci4/(:any)',        'C_page::bwci4/$1');

  $routes->add('(:any)/(:any)',       'C_page::sub/$1/$2');
  $routes->add('(:any)',              'C_page::index/$1');
endif;
