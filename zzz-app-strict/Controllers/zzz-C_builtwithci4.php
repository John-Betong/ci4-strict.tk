...
use App\Models\M_builtwithci4;

class C_builtwithci4 extends BaseController
{
...
public function index()
{
  ...
  $builtwithci4 = new M_builtwithci4();
  $dbName       = 'ci4';    
...
# echo '<pre>'; print_r($builtwithci4);
# echo '<hr>';
# echo print_r($heroes);
# echo '<hr>';
# die;
# fred($heroes); die;    
# fred($builtwithci4); die;    
